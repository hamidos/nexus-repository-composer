...
{
  private static final String ARCHIVE_PATH = "%s/%s/%s/%s.%s";
  ...
  /**
   * Builds the path to a archive based on the path contained in a particular context. For download routes the full
   ...
   */
  public static String buildArchivePath(final Context context) {
    TokenMatcher.State state = context.getAttributes().require(TokenMatcher.State.class);
  ...
  public static String buildArchivePath(final String vendor,
                                         final String project,
                                         final String version,
                                         @Nullable final String name,
                                         final String type)
  {
    return String.format(ARCHIVE_PATH, vendor, project, version,

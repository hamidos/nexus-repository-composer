    ...
    extends TestSupport
{
  ...
  public void buildZipballPathFromContextWithNameToken() {
    ...
    assertThat(ComposerPathUtils.buildArchivePath(context), is("testvendor/testproject/1.2.3/name.zip"));
  }
  ...
  public void buildZipballPathFromContextWithoutNameToken() {
    ...
    assertThat(ComposerPathUtils.buildArchivePath(context),
  ...
  public void buildZipballPathFromValues() {
    ...
    assertThat(ComposerPathUtils.buildArchivePath("testvendor", "testproject", "1.2.3", null, "zip"),
        is("testvendor/testproject/1.2.3/testvendor-testproject-1.2.3.zip"));
  }
